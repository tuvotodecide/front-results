...
type ElectoralLocationFormValues = {
  name: string;
  fid: string;
  address: string;
  code: string;
...
const ElectoralLocationForm: React.FC = () => {
  ...
  const handleSubmit = async (values: {
    ...
    try {
      ...
      setIsModalOpen(true);
      navigate("/resultados/recintos-electorales");
    } catch (err) {
    ...
    <>
      <div className="p-6 bg-slate-50 min-h-screen">
        <div className="w-full max-w-5xl mx-auto p-8 bg-white rounded-lg shadow-lg">
          ...
          <Formik<ElectoralLocationFormValues>
          ...
          >
            {({
              isSubmitting,
              setFieldValue,
            }: FormikProps<ElectoralLocationFormValues>) => (
              <Form className="space-y-6">
                ...
                <div className="flex justify-end space-x-4 pt-6 border-t border-gray-300">
                  <button
                    type="button"
                    onClick={() => navigate("/resultados/recintos-electorales")}
