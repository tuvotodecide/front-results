...
const MunicipalityForm: React.FC = () => {
  ...
  const handleSubmit = async (values: {
    ...
    try {
      ...
      setIsModalOpen(true);
      navigate('/resultados/municipios');
    } catch (err) {
        ...
        <div className="w-full max-w-5xl mx-auto p-8 bg-white rounded-lg shadow-lg">
          ...
          >
            {({
              isSubmitting,
              setFieldValue,
            }: FormikProps<MunicipalityFormValues>) => (
              <Form className="space-y-6">
                ...
                <div className="flex justify-end space-x-4 pt-6 border-t border-gray-300">
                  <button
                    type="button"
                    onClick={() => navigate('/resultados/municipios')}
