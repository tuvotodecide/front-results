...
import { useParams, useNavigate, useLocation } from '@/domains/resultados/navigation/compat';
...
const getErrorMessage = (error: unknown) => {
  ...
  return 'Ocurrió un error inesperado al guardar la configuración';
};
...
const ConfigurationForm = () => {
  ...
  const isCreateMode =
    location.pathname === '/configuraciones/nueva' ||
    location.pathname === '/resultados/configuraciones/nuevo';
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      navigate('/resultados/configuraciones');
    } catch (error: unknown) {
              ...
              <Form className="mt-6 space-y-6">
                ...
                <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
                  <button
                    ...
                    onClick={() => navigate('/resultados/configuraciones')}
                  >
                    Cancelar
                  </button>
                  <button
