    ...
    >
      <div className="py-4 text-center">
        ...
        <div className="mx-auto mb-8 grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="flex min-h-[156px] flex-col rounded-2xl border-2 border-slate-200 bg-white p-5 text-left">
          ...
          <div className="flex min-h-[156px] flex-col rounded-2xl border-2 border-red-200 bg-red-50 p-5 text-left">
            <div className="mb-2 flex items-center gap-2">
              <ErrorIcon />
