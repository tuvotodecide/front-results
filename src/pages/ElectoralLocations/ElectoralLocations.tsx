...
const columns: ColumnDef<ElectoralLocationsType>[] = [
  {
    ...
    header: 'Departamento',
    cell: ({ row }) =>
      row.original.electoralSeatId.municipalityId.provinceId.departmentId.name,
  },
  {
...
const ElectoralLocations: React.FC = () => {
  ...
  const handleEdit = (electoralLocation: ElectoralLocationsType) => {
    navigate(`/recintos-electorales/editar/${electoralLocation._id}`);
  };
